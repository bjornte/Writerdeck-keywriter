...
Edit-mode caret, shift-selection, backspace/delete, wrap/visual-line, undo, and combo helpers (QML). CI (`build-keywriter.sh`) inserts this file into `main.qml` before `showLobby()` after other Writerdeck QML patches.
